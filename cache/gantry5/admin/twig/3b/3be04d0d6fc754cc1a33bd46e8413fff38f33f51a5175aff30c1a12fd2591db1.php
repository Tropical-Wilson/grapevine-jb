...
class __TwigTemplate_7b9ac06245b0ae515991f1ab0e795ec2ddef0ec9650750aefab2b53054cfb17b extends Twig_Template
{
    ...
    ";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->fieldNameFilter((($context["scope"] ?? null) . ($context["name"] ?? null))), "html", null, true);
        echo "\" value=\"";
        echo twig_escape_filter($this->env, trim(twig_join_filter(($context["value"] ?? null), ",")), "html", null, true);
        echo "\" />
    ";
        // line 24
    ...
    {
        return new Twig_Source("", "forms/fields/input/multicheckbox.html.twig", "/Users/webdev/HTTP/grapevine-v3/user/plugins/gantry5/admin/templates/forms/fields/input/multicheckbox.html.twig");
    }
}
