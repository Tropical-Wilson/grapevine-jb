...
class __TwigTemplate_2afcb841bf070dcf0d86b8459e1f48e688bb10ce5c7768f0a0d81e56899c1058 extends Twig_Template
{
    ...
    <h4>
        ...
        if (($context["editable"] ?? null)) {
            ...
            echo twig_escape_filter($this->env, trim($this->getAttribute(($context["item"] ?? null), "title", array())), "html", null, true);
            echo "\" class=\"title\">";
            echo twig_escape_filter($this->env, trim($this->getAttribute(($context["item"] ?? null), "title", array())), "html", null, true);
            echo "</span>
            <i class=\"fa fa-pencil font-small\" tabindex=\"0\" aria-label=\"";
            // line 5
            echo twig_escape_filter($this->env, $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->transFilter("GANTRY5_PLATFORM_EDIT_TITLE", trim($this->getAttribute(($context["item"] ?? null), "title", array()))), "html", null, true);
...
";
    ...
    {
        return new Twig_Source("", "@gantry-admin/pages/configurations/layouts/particle-card.html.twig", "/Users/webdev/HTTP/grapevine-v3/user/plugins/gantry5/admin/templates/pages/configurations/layouts/particle-card.html.twig");
    }
}
