...
class __TwigTemplate_b3004dfec2b16267c02aa07d6dc37a46ddc4d2321beb2e217759c6c0553586fc extends Twig_Template
{
    ...
    ";
        ...
        if (($this->getAttribute(($context["blueprints"] ?? null), "type", array()) == "collection.list")) {
            ...
            if (($context["title"] ?? null)) {
                ...
                echo twig_escape_filter($this->env, trim($this->getAttribute($this->getAttribute(($context["data"] ?? null), "data", array()), ($context["title"] ?? null), array(), "array")), "html", null, true);
                ...
                // line 15
                echo twig_escape_filter($this->env, $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->transFilter("GANTRY5_PLATFORM_EDIT_TITLE", trim($this->getAttribute($this->getAttribute(($context["data"] ?? null), "data", array()), ($context["title"] ?? null), array(), "array"))), "html", null, true);
...
";
    ...
    {
        return new Twig_Source("", "@gantry-admin/pages/configurations/settings/field.html.twig", "/Users/webdev/HTTP/grapevine-v3/user/plugins/gantry5/admin/templates/pages/configurations/settings/field.html.twig");
    }
}
