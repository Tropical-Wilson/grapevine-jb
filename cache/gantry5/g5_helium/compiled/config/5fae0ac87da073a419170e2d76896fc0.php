...
return [
    ...
    'checksum' => '06c9bcfe04f45cbc1a80e4e97ea667ad',
    'files' => [
        0 => [
            'block_variations' => [
            ...
            'live_support' => [
                'file' => 'user/data/gantry5/themes/g5_helium/config/live_support/assignments.yaml',
                'modified' => 1486856971
            ],
            'offline_page' => [
    ...
    'data' => [
        ...
        'right_sidebar' => [
            'page' => [
                0 => [
                    'sample-layouts/right-sidebar' => 1
                ]
            ]
        ],
        'rows_columns' => [
        ...
        'two_sidebars_left' => [
            'page' => [
                0 => [
                    'sample-layouts/two-sidebars-left' => 1
                ]
            ]
        ],
        'two_sidebars_right' => [
            'page' => [
                0 => [
                    'sample-layouts/two-sidebars-right' => 1
                ]
            ]
        ]
    ]
